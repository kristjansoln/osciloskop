...
void osc_LCD_display_vals(struct buffer_t *buff, osc_LCD_display_t display_type, int color);    // Display buffer data on LCD. Use OSC_LCD_USE_DOTS or OSC_LCD_USE_LINES.
